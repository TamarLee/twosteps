...
<body>
  ...
  <div class="conatiner">
    <div class="red">
      ...
      <a href="{{ $value->link }}" class="btn btn-secondary ekko mr-2"><img src="{{ $value->image }}" class="img-btn">{{ $value->title }}</a>
      @endforeach
    </div>
  </div>
  <!-- endlessons -->
      ...
      <div class="col-md-3 col-12 mb-4 mb-md-0">
        <div class="prodigy mb-3">
          ...
          <div class="image-info py-3">
            ...
            <p>{{ $value->title }}</p>
            <p class="d-inline"><img src="{{ $value->eyeimage }}"> <small>300</small> <img src="{{ $value->ingrimage }}" class="pl-3"><small> 5 ინგრედიენტი</small></p>
